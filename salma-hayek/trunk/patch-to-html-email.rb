...
def patchToHtml(subject, preamble, changes)
  ...
  body << "  <style>\n"
  body << ".revision-header {background: #cccccc; padding-top: 6pt; padding-bottom: 6pt; text-align: right;}\n"
  body << ".check-in-comment {background: #eeeeee; padding-bottom: 6pt; margin-bottom: 6pt;}\n"
