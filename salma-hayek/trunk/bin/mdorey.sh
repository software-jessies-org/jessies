...
# 20 09 * * * cat /Projects/salma-hayek/bin/mdorey.sh | bash --login

~/Projects/salma-hayek/bin/nightly-build.rb ~martind/Projects/ clean
~/Projects/salma-hayek/bin/nightly-build.rb ~martind/Projects/ native-dist
