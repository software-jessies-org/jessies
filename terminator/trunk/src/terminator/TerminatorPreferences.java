...
public class TerminatorPreferences extends Preferences {
    ...
    protected void initPreferences() {
        ...
        addPreference(CURSOR_COLOR, Color.GREEN, "Cursor");
        addPreference(FOREGROUND_COLOR, NEAR_WHITE, "Text foreground");
        addPreference(SELECTION_COLOR, SELECTION_BLUE, "Selection background");
    }
