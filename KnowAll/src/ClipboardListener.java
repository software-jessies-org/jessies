...
public interface ClipboardListener {
    /**
     * Invoked when the clipboard's contents change.
     * It's assumed you're not interested in what the clipboard used to
     * contain, so there's no ClipboardEvent, just a String.
     */
    public void clipboardContentsChangedTo(String newContent);
}
