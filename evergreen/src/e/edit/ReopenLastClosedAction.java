 ...
 * We don't use ctrl+shift+t for this in Evergreen, because that hotkey opens the associated
 * unit test file for the focused file (which is more useful).
 */
public class ReopenLastClosedAction extends AbstractAction {
    public ReopenLastClosedAction() {
        GuiUtilities.configureAction(this, "R_eopen last-closed file", null);
    }
