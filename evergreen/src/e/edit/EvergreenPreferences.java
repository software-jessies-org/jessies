...
public class EvergreenPreferences extends Preferences {
    ...
    protected void initPreferences() {
        ...
        addSeparator();
        addPreference(UNINTERESTING_EXTENSIONS, ".a;.apk;.ap_;.aux;.bak;.bin;.class;.dex;.elf;.eps;.exe;.gif;.hprof;.icns;.iml;.ipr;.iws;.jar;.jpeg;.jpg;.lib;.log;.map;.o;.obj;.orig;.pdf;.png;.ps;.pyc;.pyo;.rej;.so;.swp;.texshop;.tiff;.toc", "Don't index");
