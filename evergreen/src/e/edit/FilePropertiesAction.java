...
public class FilePropertiesAction extends ETextAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        final JComboBox<String> charsetCombo = new JComboBox<>(new String[] { "UTF-8", "ISO-8859-1", "UTF-16BE", "UTF-16LE" });
        charsetCombo.setSelectedItem(buffer.getProperty(PTextBuffer.CHARSET_PROPERTY));
        
        final JComboBox<String> fileTypeCombo = new JComboBox<>(new Vector<String>(FileType.getAllFileTypeNames()));
