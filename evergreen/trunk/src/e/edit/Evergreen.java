...
public class Evergreen {
    ...
    private String getAcceptedSpellingsFilename() {
        return getPreferenceFilename("evergreen.accepted-spellings");
    }
    ...
    private void init() {
        ...
        initWindow();
        initTagsPanel();
        SpellingChecker.getSharedSpellingCheckerInstance().setUserSpellingExceptionsFile(getAcceptedSpellingsFilename());
